...
//		Data postedData = new Data(0, "SULEYMAN ALP", 1000, 33, "");
		...
		//3.Way: You can create a new constructor which doesn't have id as parameter
		
		
		System.out.println(postedData);
		//API is converting empty string to null, because of that I typed the following code
		...
		Response response = given().contentType(ContentType.JSON)
							.spec(spec).body(postedData).when().post("/{api}/{version}/{create}");
